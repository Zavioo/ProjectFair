...
const ProjectCard = ({displayData}) => {
  ...
  return (
    <>
    <Card onClick={handleShow} className='btn shadow' style={{width:"400px"}}>
        ...
        <Modal.Body>
          <div className="row align-items-center">
            ...
            <div className="col-lg-6">
              ...
              <h6 className='fw-bolder'>Languages used : <span className='text-damger'>{displayData?.language}</span></h6>
