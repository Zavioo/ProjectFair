            ...
            userProjects?.map(project => (
              <div key={project?._id} className="border rounded p-2 d-flex justify-content-between mb-3">
                ...
                <div className="d-flex align-items-center">
                  ...
                  <div className="btn">
                    <a href={project?.github} className='btn btn-secondary' target='_blank'> <i className='fa-brands fa-github'></i></a>
                    <div onClick={()=>deleteProject(project?._id)} className="btn text-danger"><i className="fa-solid fa-trash"></i></div>
                  </div>
                </div>
              </div>
            ))
